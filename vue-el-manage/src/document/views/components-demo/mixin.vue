...
<script>
import PanThumb from '@DOC/components/PanThumb'
import MdInput from '@DOC/components/MDinput'
import Mallki from '@DOC/components/TextHoverEffect/Mallki'
import DropdownMenu from '@DOC/components/Share/dropdownMenu'
import waves from '@COM/directive/waves' // 水波纹指令
