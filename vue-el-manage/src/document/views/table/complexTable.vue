...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@DOC/api/article'
import waves from '@COM/directive/waves' // Waves directive
import { parseTime } from '@COM/utils'
import Pagination from '@DOC/components/Pagination' // Secondary package based on el-pagination
