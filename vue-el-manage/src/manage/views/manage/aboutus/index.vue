<template>
    <div class="container">
        <div :class="control.state.showInfoStyle" v-show="control.state.isShow">
            <aboutus-manage ref="aboutusManage" :onAdd="addBtn" :onEdit="editBtn"></aboutus-manage>
        </div>
      ...
      <div class="panel-group" :class="control.state.editInfoStyle" v-show="control.state.isEdit">
        <el-row class="  card-panel  animated pulse " :gutter="20">
            <aboutus-edit ref="aboutusEdit" :onBack="AddCancelBtn"></aboutus-edit>
        </el-row>
      </div>
    </div>
...
import aboutusManage from "./components/aboutusManage";
