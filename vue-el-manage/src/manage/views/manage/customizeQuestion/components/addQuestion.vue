    ...
    <div>
        <el-header class="header">
            <el-row class="headerbtn">
                <span class="title; span-style">添加问题</span>
            </el-row>
        </el-header>
        <el-main>
            <div class="div-style">
                    ...
                    <el-row class="panel-group" :gutter="24">
                        <el-col>
                            <el-form-item label="问题描述：" prop="questionDescription">
                                <el-input class="col-input" v-model="form.questionDescription"
                                          placeholder="请输入问题"></el-input>
                            </el-form-item>
                            <el-form-item label="优先级：" prop="sequen">
                                <el-input class="col-input" v-model="form.sequen"
                                          placeholder="请输入问题优先级（数字，值越小优先级越高）"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
