                        ...
                        <el-col>
                            <el-form-item label="发布类型：" prop="taskType">
                                <el-radio-group v-model="form.taskType" @change="taskTypeRadioChange" size="small">
                                    <el-radio v-for="item in taskTypeOptions" :key="index" :label="item.code"
                                    >{{ item.name }}
                                    </el-radio>
                                </el-radio-group>
    ...
    methods: {
        ...
        getFirstTableData() {
            ...
            this.$nextTick(async () => {
                ...
                this.taskTypeRadioChange();

                this.$refs.selectUserList.editManage(res.userIds);
            });
        },
        ...
        update() {
            ...
            this.$nextTick(async () => {
                ...
                console.log("this.forma",this.form)
                let params = {
                    className: 'Notes',
                    method: 'updateNotes',
                    param: this.form,
