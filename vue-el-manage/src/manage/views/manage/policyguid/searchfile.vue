      ...
      <span>
       <el-form ref="addfrom" :model="addfrom"  label-width="80px">
        ...
        <el-button size="small" type="primary">上传文件</el-button>
          ...
          <!--<template>-->
            <!--<el-radio v-model="hotistop" label="1">是</el-radio>-->
            <!--<el-radio v-model="hotistop" label="0">否</el-radio>-->
          <!--</template>-->
          <!--</el-form-item>-->

<!--         <el-form-item label="首页材料">-->
<!--          <template>-->
<!--            <el-radio v-model="addfrom.importfile" label="1">是</el-radio>-->
<!--            <el-radio v-model="addfrom.importfile" label="2">否</el-radio>-->
<!--          </template>-->
<!--          </el-form-item>-->

<!--         <el-form-item>-->
<!--            <el-table :data="chapters" v-if="chapters!=null||chapters.length!=0"   highlight-current-row v-loading="listLoading"  style="width: 100%;">-->

<!--        <el-table-column type="index" width="60">-->
<!--        </el-table-column>-->
<!--        <el-table-column  prop="code" label="章节编号" width="100" >-->
<!--        </el-table-column>-->
<!--        <el-table-column  prop="name" label="章节名称" width="200" >-->
<!--        </el-table-column>-->
<!--         <el-table-column  prop="attachment" label="章节名称" width="200" v-if="show">-->
<!--        </el-table-column>-->
<!--               <el-table-column  prop="attachmentname" label="章节名称" width="200">-->
<!--        </el-table-column>-->
<!--         <el-table-column  prop="sectionflag" label="sectionflag" width="200" v-if="show">-->
<!--        </el-table-column>-->
<!--              <el-table-column>-->
<!--           <template slot-scope="scope">-->
<!--            <el-button  icon="el-icon-circle-close-outline" @click="chapterDel(scope.$index, scope.row)"></el-button>-->
<!--          </template>-->
<!--              </el-table-column>-->
<!--            </el-table>-->
<!--           <el-button plain @click="ChapterList(),chapterDialogVisible = true">添加章节</el-button>-->
<!--          </el-form-item>-->
      </el-form>
       </span>
  ...
  <el-form ref="editfrom" :model="editfrom"  label-width="80px">
    ...
    <el-form-item label="附件" prop="attachment">
        ...
        <!--<el-form-item label="是否置顶">-->
          <!--<template>-->
            <!--<el-radio v-model="editfrom.istop" label="1">是</el-radio>-->
            <!--<el-radio v-model="editfrom.istop" label="0">否</el-radio>-->
          <!--</template>-->
        <!--</el-form-item>-->

<!--         <el-form-item label="首页材料">-->
<!--          <template>-->
<!--            <el-radio v-model="editfrom.importfile" label="1">是</el-radio>-->
<!--            <el-radio v-model="editfrom.importfile" label="2">否</el-radio>-->
<!--          </template>-->
<!--          </el-form-item>-->

<!--         <el-form-item>-->
<!--            <el-table :data="editfrom.chapterSet" v-if="editfrom.chapterSet!=null||editfrom.chapterSet.length!=0"   highlight-current-row v-loading="listLoading"  style="width: 100%;">-->
<!--        <el-table-column type="index" width="60">-->
<!--        </el-table-column>-->
<!--        <el-table-column  prop="code" label="章节编号" width="100" >-->
<!--        </el-table-column>-->
...
<!--            <el-button  icon="el-icon-circle-close-outline" @click="handlechapterDel(scope.$index, scope.row)"></el-button>-->
<!--          </template>-->
<!--        </el-table-column>-->
<!--            </el-table>-->
<!--           <el-button plain @click="ChapterList(),chapterDialogVisible = true">添加章节</el-button>-->
    ...
    export default {
      ...
      methods: {
       ...
       chapterDel(index,row){
        ...
        //获取用户列表
        //20200911-xues-交易锦囊只拿kind为"purchaseIdea"的数据
        getFiles() {
          let _this = this;
          this.$nextTick(async () =>{
            let param = {
