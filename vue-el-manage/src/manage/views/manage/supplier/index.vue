<template>
    ...
    <el-row class="panel-group" :gutter="20">
      <el-col :xs="24" :sm="24" :lg="24" class="card-panel-col">
        <div class="card-panel animated pulse">
           <supplier-Info :onAdd="AddBtn"  :onModify="EditBtn"></supplier-Info>
        </div>
      </el-col>
    </el-row>
  </div>
  <div class="panel-group" :class="control.state.addInfoStyle" v-if="control.state.isAdd">
    <el-row class="card-panel animated pulse" :gutter="20">
       <Supplier-Add :onBack="AddCancelBtn"></Supplier-Add>
    </el-row>
  </div>
  <div class="panel-group" :class="control.state.editInfoStyle" v-if="control.state.isEdit">
  <el-row class="card-panel animated pulse" :gutter="20">
      <Supplier-Detail :onBack="EditCancelBtn"></Supplier-Detail>
  </el-row>
  </div>
</div>
</template>
...
<script>
  ...
  import SupplierAdd from './supplierInfo/addSupplierInfo';
  import SupplierDetail from './supplierInfo/SupplierDetail';
