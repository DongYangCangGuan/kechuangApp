<template>
    <div class="container">
        <div :class="control.state.showInfoStyle" v-show="control.state.isShow">
            <user-info-manage ref="userInfoManage" :on-add="addBtn"
                              :on-edit="editBtn" :on-detail="detailBtn"></user-info-manage>
        </div>

        <div class="panel-group" :class="control.state.addInfoStyle" v-show="control.state.isAdd">
            <el-row class="  animated pulse " :gutter="20">
                <add-user-info ref="addUserInfo" :onBack="AddCancelBtn"></add-user-info>
            </el-row>
        </div>

        <div class="panel-group" :class="control.state.editInfoStyle" v-show="control.state.isEdit">
            <el-row class="  animated pulse " :gutter="20">
                <edit-user-info ref="editUserInfo" :onBack="AddCancelBtn"></edit-user-info>
            </el-row>
        </div>

        <div class="panel-group" :class="control.state.detailInfoStyle" v-show="control.state.isDetail">
            <el-row class="  animated pulse " :gutter="20">
                <user-info-detail ref="userInfoDetail" :onBack="AddCancelBtn"></user-info-detail>
            </el-row>
        </div>
    </div>
</template>
